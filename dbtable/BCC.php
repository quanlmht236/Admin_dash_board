    ...
    <div class="panel-tbody">
        ...
        ?>
            <tr>
                ...
                <td align="center"><a class="btn btn-default" href="../add/editbcc.php?updatecc=<?=$macc?>"><em class="fa fa-pencil"></em></a> <a class="btn btn-danger"><em class="fa fa-trash"></em></a></td>
            </tr>
        <?php
        }
        ?>
